...
The following cost estimations outline the required AWS infrastructure spend for standard On-Demand pricing. Adopting Compute Savings Plans and Reserved Instances will reduce compute/database costs by roughly 30-40%.
...
| **Miscellaneous** | CloudWatch Basic | ~$10 |
| **Total Estimated Cost** | | **~$225 / month** |
...
| **Miscellaneous** | CloudWatch, SQS | ~$50 |
| **Total Estimated Cost** | | **~$1,315 / month** |
...
| **ALB / NLB** | Heavy LCU usage, WAF | ~$200 |
...
| **Miscellaneous** | CloudWatch Logs/Metrics, SQS | ~$300 |
| **Total Estimated Cost** | | **~$7,250 / month** |
